var challenges = [
    {
        "text": "On retire qu'un seul bloc à la fois",
        "duration": 15
    },
    {
        "text": "On ne maintient pas la structure",
        "duration": 15
    },
    {
        "text": "On écarte les jambes d'un peu plus de la largeur des épaules",
        "duration": 30
    },
    {
        "text": "On se met à un pas du jeu",
        "duration": 30
    },
    {
...
var description = "Inspiré par le livre The Adventure Challenge in bed.\n\n" +
    ...
    "Quand la tour s'est effondrée, comptez le nombre de blocs que vous avez pu retirer. Celui qui en a retiré le plus a gagné... un massage ou un gage de votre choix!\n\n" +
    "Amusez-vous bien!";
var startButton = "Commencer";
var endgame = "Fin du jeu";
var restartButton = "Relancer";
var restartText = "Appuyez sur le bouton pour relancer le jeu.";
